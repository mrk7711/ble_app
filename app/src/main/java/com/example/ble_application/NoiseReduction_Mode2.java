...
public class NoiseReduction_Mode2 extends AppCompatActivity {
    private Button b1;
    private SeekBar s1;
    private TextView t1;
    private int x=0;
    ...
    private static final String PREFS_NAMEB = "SeekBarPrefs2";
    private static final String KEY_SEEKBAR_VALUEB = "seekBarValue2";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_noise_reduction_mode2);
        ...
        SharedPreferences preferences = getSharedPreferences(PREFS_NAMEB, MODE_PRIVATE);
        int y = preferences.getInt(KEY_SEEKBAR_VALUEB, 0);
        s1.setProgress(y);
        if (y==0)
        {
        ...
        s1.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                ...
                editor.putInt(KEY_SEEKBAR_VALUEB, progress);
                editor.apply();
                x = progress;
                if (x==0)
                    t1.setText(getString(R.string.OFF));
